...
from processor.aspectawarepreprocessor import AspectAwarePreprocessor
...
split = train_test_split(trainPaths, trainLabels, test_size=0.25, stratify=trainLabels, random_state=42)
